...
if(WIN32 AND NOT CYGWIN)
  ...
  if (NOT ANDROID)
    message(FATAL_ERROR "No Android variables set!")
  endif()
...
if(NOT APPLE)
  ...
  if (ANDROID_ABI STREQUAL "armeabi-v7a")
    add_definitions(-DF_GET_POS_MISSING_DECL=1)
    SET(HAVE_FSEEKO 0)
  elseif(ANDROID_ABI STREQUAL "x86")
    add_definitions(-DF_GET_POS_MISSING_DECL=1)
    SET(HAVE_FSEEKO 0)
...
if(HAVE_INT_STRERROR_R OR ANDROID)
